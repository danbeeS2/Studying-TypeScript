...
console.log((0, _lodashDefault.default).camelCase(str));
console.log((0, _lodashDefault.default).snakeCase(str));
console.log((0, _lodashDefault.default).kebabCase(str));
